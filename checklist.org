...
* Things to revisit
- [ ] Possible abbreviations: see table in below notes.
- [X] 23.png: ~of the soul; ... But true~ -- leave spacing as-is
- [ ] 05.png: Chapter I subtitle: centered, not hanging indent
- [ ] 16.png: Chapter II subtitle: centered, not hanging indent
- [ ] 17.png: "odium theologicum" (Latin?)
- [ ] 38.png: Chapter III subtitle: centered, not hanging indent
- [ ] 04.png: right-alignment for signature
- [ ] 12.png: poetry
- [ ] 14.png: poetry (4x)
- [ ] 61.png: poetry
* Transcriber Notes
