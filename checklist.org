...
* Things to revisit
- [X] Possible abbreviations: see table in below notes.
- [X] 23.png: ~of the soul; ... But true~ -- leave spacing as-is
- [X] 05.png: Chapter I subtitle: centered, not hanging indent
- [X] 16.png: Chapter II subtitle: centered, not hanging indent
- [X] 17.png: "odium theologicum" (Latin?)
- [X] 38.png: Chapter III subtitle: centered, not hanging indent
- [X] 04.png: right-alignment for signature
- [X] 12.png: poetry
- [X] 14.png: poetry (4x)
- [X] 61.png: poetry
- [X] Don't use punctuation ~:~ or ~?~ in title for SR.
- [X] Add ~abbr[title]~ to CSS, rebuild books, check for underlines
- [X] Reconvert KEPUB with Calibre; check on Kobo again
** Ebook review
*** Justification (or lack thereof)
- Kindle Preview on Mac ignored my CSS and justified text anyway. It has no setting to change, but in my iPhone app I turned that off and ragged-right is working fine.
- Actual Kindle apps have a setting; this is only a Previewer problem.
*** Punctuation in book title
- Apple Books, Mac: title = ~The Bible_ should it be in the school room_~
- ADE: title is the same
- Title tag in the underlying XHTML looks fine.
  #+begin_src html
  <title>The Bible: should it be in the school room? | Project Gutenberg</title>
  #+end_src
- Oddly, =content.opf= (which is XML) has a different title! Where did this version come from?
  #+begin_src xml
  <dc:title id="id-1">The Bible, should it be in the school room</dc:title>
  #+end_src
- And =toc.ncx= has the version seen by the e-readers:
  #+begin_src xml
  <docTitle>
    <text>The Bible_ should it be in the school room_</text>
  </docTitle>
  #+end_src
- =toc.xhtml= is the same as =toc.ncx=
- It seems that maybe ebookmaker stripped ~:~ and ~?~ from the title and I should avoid those in the title, and use the title that appears in the DP project page.
*** Page breaks
- Google Play Books ignores page breaks
*** Abbreviation underlines
- Kobo converted by Calibre is underling ~<abbr>~
- Does Kobo EPUB convert do that too?
- Still there after a convert with ~abbr[title]~ ...
- But EPUB3 in Calibre reader doesn't do it.
* Transcriber Notes
- text version contains ~=bold text=~ markup
- html version: Table of Contents was added.
- p. 8: added “in” after “belief” (Action or conduct indicating a belief in)
- p. 12: changed “of” to “to” (on earth peace to men of good will)
- p. 24: changed “depotism” to “despotism” (never rises above the merest despotism)
- p. 24: changed “in” to “is” (Much less is Christianity or any other system)
- p. 24: changed “almightly” to “almighty” (It is not almighty and we are not to look)
- p. 31: changed “summonded” to “summoned” (The teacher, summoned as a witness)
- p. 32: changed “ther” to “their” (put to death for participating in their production)
- p. 41: “Wicliffe’s” left as-printed; this name has many variant spellings.
- p. 46: changed incorrect citation “xl” to “xlvi” (Gen. xlvi. 23)
- p. 61: changed “prohpet’s” to “prophet’s” (Still at the prophet’s feet)
- p. 61: changed “nation’s” to “nations” (at the prophet’s feet the nations sit)
* Notes
** General notes
...
** Smooth reader notes
** Forum notes
- 23.png: ~of the soul; ... But true~ -- leave spacing as-is
** Project comments
#+begin_src markdown
# Description
Book from 1924 examining whether the Bible should be used in schools. For reference, this is one year before the Scopes monkey trial, about teaching evolution in schools.

Personal scans, so they're not on the internet.

This book was produced by Haldeman-Julius Publications, a small press located in southeast Kansas. Almost all of their books were 64 pages or less, printed on cheap pulp paper, and priced very cheaply. They sold millions of them but few are left, because the paper was so low grade and the covers were also just paper. You can read about the company [here at wikipedia.](https://en.wikipedia.org/wiki/Little_Blue_Book)

# Proofreading
Nothing out of the ordinary.
 
# Formatting
Chapters are named "Chapter." Section headings are centered, in small or all caps. Paragraphs that start with a Roman numeral should not be considered new sections.

# Post Processing
This project is reserved for dlowe.
#+end_src
* Checklist
** Process the Pages
...
./make_project.py
#+end_src
- [X] Read the [[https://www.pgdp.net/c/project.php?id=projectID68cd8bd790a52#project-comments][project comments]]
- [X] Subscribe to the [[https://www.pgdp.net/phpBB3/viewtopic.php?t=84625][forum topic]] and read all posts
- [X] Open ~bibleschool-utf8.txt~ in Guiguts
...
*** Fix Sidenotes
- [X] Read the [[https://www.pgdp.net/wiki/PPTools/Guiguts/Fixup#Sidenotes][discussion]]. Step through sidenotes with: Search & Replace of ~[S~, not regex, not whole word, ignore case. Click ~Search~ to find each Sidenote.
...
- [X] Use ~File → Save a Copy As` to make `bibleschool.html~
...
- [X] Re-open ~bibleschool-utf8.txt~ (if not still open).
...
- [X] Open ~bibleschool.html~ that was saved previously.
...
- [X] Scroll through in multiple browsers (Safari, Chrome, Firefox, etc.)
...
- [X] HTML → Ebookmaker (online) - build EPUB2 and EPUB3
- [X] Review in Apple Books; focus on page breaks and major issues
** Build and upload ebooks
- [X] If any changes were made from previous step, rebuild EPUB3
- [X] Optional: Convert EPUB3 to KEPUB with Calibre
- [X] Optional: Upload EPUB3 with [[https://www.amazon.com/gp/sendtokindle][Send to Kindle]]
- [X] Add epub3 to Apple Books
- [X] Optional: Add EPUB3, KEPUB to Dropbox for Kobo, Android, etc
*** Ebook review
...
- [X] Go to [[https://www.pgdp.net/c/project.php?id=projectID68cd8bd790a52][project page]], select SR time period, upload ~bibleschool-sr.zip~
...
- [X] Add *anonymized* files to git, e.g. ~bibleschool-smoothread01.txt~
...
- [X] ~make zip~
- [X] Run through [[https://ebookmaker.pglaf.org/][ebookmaker]], check output.txt
  - No errors!
  - Warnings are OK
  - Copy link to the output.txt file (will persist about 3 days)
- [X] Go to the [[https://upload.pglaf.org/][PGLAF upload site]]
- [X] Enter copyright clearance (get from DP [[https://www.pgdp.net/c/project.php?id=projectID68cd8bd790a52][project page]])
...
- [X] Credits line
  - Paste in from DP [[https://www.pgdp.net/c/project.php?id=projectID68cd8bd790a52][project page]]
...
** Project wrap-up
- [X] When posted, then update PG URL in README.md, and [[https://tangledhelix.com/about][personal website list]], and set homepage on GitHub project
